...
class UsuarioServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CrearUsuario = channel.unary_unary(
                ...
                request_serializer=usuarios__pb2.CreateUserRequest.SerializeToString,
                response_deserializer=usuarios__pb2.CreateUserResponse.FromString,
                _registered_method=True)
        self.ModificarUsuario = channel.unary_unary(
                '/usuarios.UsuarioService/ModificarUsuario',
                request_serializer=usuarios__pb2.UpdateUserRequest.SerializeToString,
                response_deserializer=usuarios__pb2.UpdateAndDeleteUserResponse.FromString,
                _registered_method=True)
...
def add_UsuarioServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'CrearUsuario': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=usuarios__pb2.CreateUserRequest.FromString,
                    response_serializer=usuarios__pb2.CreateUserResponse.SerializeToString,
            ),
            'ModificarUsuario': grpc.unary_unary_rpc_method_handler(
                    servicer.ModificarUsuario,
                    request_deserializer=usuarios__pb2.UpdateUserRequest.FromString,
                    response_serializer=usuarios__pb2.UpdateAndDeleteUserResponse.SerializeToString,
            ),
...
class UsuarioService(object):
    ...
    def CrearUsuario(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/usuarios.UsuarioService/CrearUsuario',
            usuarios__pb2.CreateUserRequest.SerializeToString,
            usuarios__pb2.CreateUserResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def ModificarUsuario(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/usuarios.UsuarioService/ModificarUsuario',
            usuarios__pb2.UpdateUserRequest.SerializeToString,
            usuarios__pb2.UpdateAndDeleteUserResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
